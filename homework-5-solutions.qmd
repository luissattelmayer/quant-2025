...
mainstream_parties <- read_csv(here::here("session2/data/mainstream_parties_simulated.csv"))
...
It is a sharp design. The far-right either entered or did not enter relative to the cutoff. It relies on exogenous variation created through differences in electoral thresholds, which serves as a clear-cut and deterministic assignment mechanism. Since the study attributes changes in mainstream party positions to radical right success using electoral thresholds as the cutoff, this suggests a sharp RD rather than a fuzzy RD, where treatment probability would only increase at the threshold rather than being strictly determined by it.


#### What is the treatment, what is the outcome, and what is the running variable?

1. Treatment: the treatment is a radical right party passing or not passing the electoral threshold to enter parliament
2. Outcome: our outcome is the immigration position of mainstream parties, or rather the shifts
3. Running variable/forcing function: share of radical right votes
